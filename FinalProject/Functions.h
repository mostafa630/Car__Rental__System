...
void add_rental(int cust_idx, string car_lpn, string car_type, string cust_id, bool stat, date dat, int cst)
{
	...
	arr_rtl[rtl_idx].dat.rc_day = dat.rc_day;
	arr_rtl[rtl_idx].dat.rc_month = dat.rc_month;
	arr_rtl[rtl_idx].dat.rc_year = dat.rc_year;
	arr_rtl[rtl_idx].dat.rtn_day = dat.rtn_day;
	arr_rtl[rtl_idx].dat.rtn_month = dat.rtn_month;
	arr_rtl[rtl_idx].dat.rtn_year = dat.rtn_year;
	arr_rtl[rtl_idx].dat.num_hours = dat.num_hours;
